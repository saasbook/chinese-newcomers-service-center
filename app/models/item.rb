class Item < ActiveRecord::Base
    ...
    def self.k_headings_names_and_fields
        return [["Case Inventory", self.k_case_inventory, 
                    [:K_1A, :K_1B, :K_1C, :K_1D, :K_1E], "check_box_tag"], 
                ...
                ["Additional Case Information", self.k_additional_case_information, 
                    [:K_3, :K_4, :K_5, :K_6, :K_7, :K_8, :K_9, :K_10], "check_box_tag"],
                ["Tax Court Activities", self.k_tax_court_activities, 
                    [:K_12, :K_13, :K_14], "check_box_tag"],
                ["Closed Case Outcomes", self.k_closed_case_outcomes,
                    [:K_15A, :K_15B, :K_15C, :K_15D], "check_box_tag"]]
    end
